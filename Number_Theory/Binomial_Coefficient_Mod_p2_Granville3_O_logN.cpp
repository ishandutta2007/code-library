...
ll binomod(ll n, ll m, ll p, ll q) {
  static int ndigs[binomod_maxdigs], mdigs[binomod_maxdigs],
      rdigs[binomod_maxdigs], N[binomod_maxdigs], M[binomod_maxdigs],
      R[binomod_maxdigs], e[binomod_maxdigs];
...
// https://github.com/touristnct/algo/blob/211f178b261ee41e10f32b6a7ecd5ffc328b1c04/binomod.cpp
