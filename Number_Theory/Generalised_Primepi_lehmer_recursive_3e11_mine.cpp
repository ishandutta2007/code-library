#include <bits/stdc++.h>
using namespace std;
// count prime timings(not working)
...
const int PHI_N = 125000;
const int PHI_M = 166;
const int MAX_PRIMES = 20000010;
...
void init_tinyphi(int PHI_N, int PHI_M, int k) {
