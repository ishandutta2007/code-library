...
void MatrixAdd(double A[][SIZE], double B[][SIZE], double Result[][SIZE],
               int N) {
  int i, j;
...
void MatrixSubtrac(double A[][SIZE], double B[][SIZE], double Result[][SIZE],
                   int N) {
  int i, j;
...
void StrassenAlgorithm(double A[][SIZE], double B[][SIZE], double C[][SIZE],
                       int N) {
  ...
  // other cases are treated here:
    ...
    double P1[SIZE][SIZE], P2[SIZE][SIZE], P3[SIZE][SIZE], P4[SIZE][SIZE],
        P5[SIZE][SIZE], P6[SIZE][SIZE], P7[SIZE][SIZE];
    ...
    StrassenAlgorithm(AResult, BResult, P1,
                      Divide); // p1 = (a11+a22) * (b11+b22)
    ...
    StrassenAlgorithm(AResult, BResult, P6,
                      Divide); // p6 = (a21-a11) * (b11+b12)

    MatrixSubtrac(A12, A22, AResult, Divide); // a12 - a22
    MatrixAdd(B21, B22, BResult, Divide);     // b21 + b22
    StrassenAlgorithm(AResult, BResult, P7,
                      Divide); // p7 = (a12-a22) * (b21+b22)
