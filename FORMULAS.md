...
| $f(x)=\sum_{i\le x} \sigma_1(i)$[A024916](https://oeis.org/A024916)|$\sum_{i\le x} f(x/i)= \sum_{d\|x} \sigma_1(d)$[A280077](https://oeis.org/A280077)</br>$= \sum_{k\le x}\sigma_1(k)\lfloor{x/k}\rfloor$|--|--|--|--|--|
